...
public class CustomActivity extends Activity implements View.OnClickListener {
    ...
    private ImageView mPictureLogo;
    private ImageView mPictureBlack;
    /**
     * 生成二维码
     */
    ...
    private void initView() {
        ...
        mPictureLogo = (ImageView) findViewById(R.id.picture_logo);
        mPictureLogo.setOnClickListener(this);
        mPictureBlack = (ImageView) findViewById(R.id.picture_black);
        mPictureBlack.setOnClickListener(this);
    ...
    private void saveImg(Bitmap bitmap){
        ...
        boolean isSaveSuccess = ImageUtil.saveImageToGallery(CustomActivity.this, bitmap,fileName);
        if (isSaveSuccess) {
            Toast.makeText(CustomActivity.this, "图片已保存至本地", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(CustomActivity.this, "保存图片失败，请稍后重试", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void generateQrcodeAndDisplay() {
        ...
        String str_width = mEtWidth.getText().toString();
        String str_height = mEtHeight.getText().toString();
        ...
        mIvQrcode.setImageBitmap(qrcode_bitmap);
    }
    ...
    private void imgChooseDialog(){
        AlertDialog.Builder choiceBuilder = new AlertDialog.Builder(CustomActivity.this);
        choiceBuilder.setCancelable(false);
        choiceBuilder
                .setTitle("选择")
    ...
    private void takePhoto() {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(CustomActivity.this, "com.example.ymz.qr.fileprovider", outputImage);
        }
        // 启动相机程序
    ...
    private void choosePhotoFromAlbum() {
        if (ContextCompat.checkSelfPermission(CustomActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(CustomActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        } else {
            openAlbum();
        }
    }
